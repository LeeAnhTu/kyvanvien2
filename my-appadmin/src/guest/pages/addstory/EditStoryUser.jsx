  ...
  useEffect(() => {
    const fetchStory = async () => {
      try {
        ...
        setCheckStory(response.data.checkStory);
      } catch (error) {
  ...
  const handleSave = async () => {
    try {
      if (story) {
        ...
        setTimeout(() => {
          window.location.href = `/dang-truyen/sua-truyen/${id}`; // Redirect to list story page
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title">Cập nhật truyện</h5>
                <div>
                  {story ? (
                    <div>
                      <div className="row mb-3">
                        <label htmlFor="inputTitle" className="col-sm-1 col-form-label">Tên:</label>
                      ...
                      <div className="row mb-3">
                        <label htmlFor="inputAuthor" className="col-sm-1 col-form-label">Tác Giả:</label>
                        <div className="col-sm-10">
                      ...
                      <div className="row mb-3">
                        <label htmlFor="selectType" className="col-sm-1 col-form-label">Kiểu:</label>
                        ...
                        <label htmlFor="selectGenre" className="col-sm-1 col-form-label">Thể Loại:</label>
                        ...
                        <label htmlFor="selectStatus" className="col-sm-1 col-form-label">Trạng Thái:</label>
                        <div className="col-sm-3">
                      ...
                      <div className="row mb-3" style={{ display: 'flex', alignItems: 'center' }}>
                        <label htmlFor="inputImage" className="col-sm-1 col-form-label">Ảnh:</label>
